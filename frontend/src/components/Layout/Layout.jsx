...
// Shown once when an authenticated user has no profile data (role/name missing).
// This happens when Firestore rules aren't deployed yet or the user doc was never created.
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 space-y-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-gray-900 text-lg leading-tight">Complete Your Profile</h2>
...
export default function Layout() {
  ...
  // Show the profile setup prompt when a logged-in user has no name/role data
