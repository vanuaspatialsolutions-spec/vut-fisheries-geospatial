...
function ProvinceSummary({data,loading}){
  if(loading)return(<div className="space-y-2">{[1,2,3].map(i=><div key={i} className="h-10 rounded-lg animate-pulse" style={{background:'rgba(37,99,235,0.04)'}}/>)}</div>);
  ...
  return(
    <div className="space-y-6 fade-in">
          ...
          <div className="card">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div key={label} className="rounded-xl p-4" style={{background:'rgba(37,99,235,0.03)',border:'1px solid rgba(37,99,235,0.07)'}}>
                  ...
                  {statsLoading?<div className="h-7 w-12 rounded animate-pulse" style={{background:'rgba(37,99,235,0.09)'}}/>:<p className="text-2xl font-bold text-gray-800">{value}</p>}
      ...
      <div className="card">
        ...
        {statsLoading ? (
          <div className="space-y-3">{[1,2,3].map(i=><div key={i} className="h-14 rounded-xl animate-pulse" style={{background:'rgba(37,99,235,0.05)'}}/>)}</div>
            ...
            {datasetByCategory.map(cat=>{
              ...
              return (
                <div key={cat.key}>
                  ...
                  <div className="h-2.5 rounded-full" style={{background:'rgba(37,99,235,0.07)'}}>
