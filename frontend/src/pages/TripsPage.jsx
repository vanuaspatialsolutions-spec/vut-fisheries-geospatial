    ...
    <div className="space-y-5">
      <div className="page-header">
        <div>
          ...
          <p className="page-subtitle">Field trip plans — saved trips appear on the Schedule calendar</p>
        </div>
      ...
      {trips.length === 0 ? (
        <div className="card flex flex-col items-center py-20 gap-4 text-center">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mt-1">Plan a field trip and it will appear on your Schedule calendar.</p>
          </div>
          <button onClick={() => navigate('/trips/new')} className="btn-primary">
